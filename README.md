...
npm install
npm run dev
The application will be available at http://localhost:5173 (or the next available port if 5173 is in use). To install and run the backend server, navigate to the backend directory, activate the Python virtual environment, and execute:
